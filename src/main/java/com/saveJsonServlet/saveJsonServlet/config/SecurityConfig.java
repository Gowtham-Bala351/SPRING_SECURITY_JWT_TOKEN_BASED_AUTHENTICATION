package com.saveJsonServlet.saveJsonServlet.config;
...
import com.saveJsonServlet.saveJsonServlet.Controller.RequestCachingFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
	 ...
	 public AuthenticationProvider authenticationProvider() {
	    ...
	    public FilterRegistrationBean<RequestCachingFilter> requestCachingFilter() {
	        ...
	        registrationBean.addUrlPatterns("/login"); // Use your endpoint or /* for global
